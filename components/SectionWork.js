      ...
      <div className="container">
        <header className="flow-content">
          <h2 className="section-title">
            What {"I’ve"} been <span className="text-accent">working on</span>
          </h2>
          <p className="spacer">
            I like to keep busy and always have a project on the side to
            practice and implement the new things {"I’m"}
            constantly learning. Here are a few of my works that {"I’ve"}{" "}
            dedicated my time towards.
          </p>
        </header>
        <div className="projects spacer">
          ...
          <article className="card">
            <div className="mockup">
              <a target="_blank" href="https://ghiblihub.vercel.app/">
                <Image
